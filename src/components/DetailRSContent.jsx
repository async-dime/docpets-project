                    ...
                    <Row>
                        <div className="d-flex">                            
                            <button
                                ...
                                className={`detailButtonBook ${
                                    day === "1" ? "detailButtonBookClick" : ""
                                }`}
                            >
                                Senin, <br /> 11 Januari
                            </button>
