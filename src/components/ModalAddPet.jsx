  ...
  return (
    <div>
      <div style={modalAddPetStyle}>
        ...
        <Modal show={isOpen} onHide={hideModal} className="modal-pet" centered>
          ...
          <Modal.Body className="add-pet-form">
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              />
              <br />
              <label className="border-0 my-2" htmlFor="PilihHewan">
          ...
          <Modal.Footer className="modal-footer-pet border-0 my-2">
            <button onClick={handleSubmit} className="add-pet-button btn-block">
              Tambahkan
            </button>
          </Modal.Footer>
        </Modal>
