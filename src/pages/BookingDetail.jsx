                                            ...
                                            <div className="row">
                                                {doctors ? doctors.map((doctor) => (
                                                    <div className="col-lg-4 col-sm-12 col-md-6">
                                                        <div onClick={() => { setDokter(doctor.id), setDokterName(doctor.user.fullname) }}
                                                            id={doctor.id}
                                                            ...
                                                            <Modal isOpen={modal} toggle={toggle} className='modal-pet'>
                                                                ...
                                                                <ModalBody className='form-pet'>
                                                                    <div className="row">
                                                                        ...
                                                                        {pets.map(pet =>
                                                                            <div className={`modal-book-pet col-3 ${petModal === pet.id ? 'modal-book-pet-active' : ''}`} onClick={() => { setPetModal(pet.id), setPetName(pet.name), setPetGender(pet.gender), setPetSpecyId(pet.petSpecyId) }} id={pet.id}>
